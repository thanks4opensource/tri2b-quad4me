define quad4me
    ...
    printf "data              : %d -> %d\n", \
           (bool)(GPIOB->ODR & quad4me_config::DATA_GPIO_BIT), \
           (bool)(GPIOB->IDR & quad4me_config::DATA_GPIO_BIT)
    printf "alrt              : %d -> %d\n", \
           (bool)(GPIOB->ODR & quad4me_config::ALRT_GPIO_BIT), \
           (bool)(GPIOB->IDR & quad4me_config::ALRT_GPIO_BIT)
    printf "ltch              : %d -> %d\n", \
           (bool)(GPIOB->ODR & quad4me_config::LTCH_GPIO_BIT), \
           (bool)(GPIOB->IDR & quad4me_config::LTCH_GPIO_BIT)
    printf "cycl              : %d -> %d\n", \
           (bool)(GPIOB->ODR & quad4me_config::CYCL_GPIO_BIT), \
           (bool)(GPIOB->IDR & quad4me_config::CYCL_GPIO_BIT)

    printf "EXTI              : IMR %c  RTSR %c  FTSR %c  PR %c\n", \
           EXTI->IMR  & quad4me_config::ALRT_EXTI_BIT ? 'y' : 'n' , \
           EXTI->RTSR & quad4me_config::ALRT_EXTI_BIT ? 'y' : 'n' , \
           EXTI->FTSR & quad4me_config::ALRT_EXTI_BIT ? 'y' : 'n' , \
           EXTI->PR   & quad4me_config::ALRT_EXTI_BIT ? 'y' : 'n'
...
"E %d%d %s-%s-%s %c%c%c%c->%c%c%c%c %c%c%c%c %02d/%02d %08x-%08x-%08x %x:%02d:%-2d  %2d/%c/0x%08x\n", \
_NODE_ID, \
_rank, \
...
_ROLE_STRINGS [_role ], \
\
(bool)(GPIOB->ODR & quad4me_config::DATA_GPIO_BIT) ? 'd' : '.', \
(bool)(GPIOB->ODR & quad4me_config::ALRT_GPIO_BIT) ? 'a' : '.', \
(bool)(GPIOB->ODR & quad4me_config::LTCH_GPIO_BIT) ? 'l' : '.', \
(bool)(GPIOB->ODR & quad4me_config::CYCL_GPIO_BIT) ? 'c' : '.', \
(bool)(GPIOB->IDR & quad4me_config::DATA_GPIO_BIT) ? 'd' : '.', \
(bool)(GPIOB->IDR & quad4me_config::ALRT_GPIO_BIT) ? 'a' : '.', \
(bool)(GPIOB->IDR & quad4me_config::LTCH_GPIO_BIT) ? 'l' : '.', \
(bool)(GPIOB->IDR & quad4me_config::CYCL_GPIO_BIT) ? 'c' : '.', \
\
EXTI->IMR  & quad4me_config::ALRT_EXTI_BIT ? 'I' : '.' , \
EXTI->RTSR & quad4me_config::ALRT_EXTI_BIT ? 'R' : '.' , \
EXTI->FTSR & quad4me_config::ALRT_EXTI_BIT ? 'F' : '.' , \
EXTI->PR   & quad4me_config::ALRT_EXTI_BIT ? 'P' : '.', \
\
